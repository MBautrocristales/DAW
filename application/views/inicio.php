    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Bienvenido a MB Autocristales
            </h1>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="<?php echo base_url(); ?>images/Publico/01_inicio/inicio_01.jpg" alt="">
            </div>
        </div>
        <br><br>
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-fw fa-check"></i> Ubicanos</h4>
                </div>
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-fw fa-gift"></i> Productos</h4>
                </div>
                <div class="panel-body">
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-fw fa-compass"></i> Contactanos</h4>
                </div>
                <div class="panel-body">
