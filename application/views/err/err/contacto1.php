    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <p><i class="fa fa-phone"></i>
                <abbr title="Phone">Teléfono</abbr>: (447) 478-4853</p>
            <p><i class="fa fa-envelope-o"></i>
                <abbr title="Email">Correo Electrónico</abbr>: <a href="mailto:mbautocristales@gmail.com">mbautocristales@gmail.com</a>
            </p>
            <p><i class="fa fa-clock-o"></i>
                <abbr title="Hours">Horario</abbr>: Lunes a Viernes: 9:00 AM a 5:00 PM</p>
                <abbr title="Hours"></abbr>Sábado: 9:00 AM a 2:00 PM</p>
